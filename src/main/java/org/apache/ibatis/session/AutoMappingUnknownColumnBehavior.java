...
public enum AutoMappingUnknownColumnBehavior {
  ...
  /**
   * Output warning log. Note: The log level of {@code
   * 'org.apache.ibatis.session.AutoMappingUnknownColumnBehavior'} must be set to {@code WARN}.
   */
  WARNING {
    @Override
    public void doAction(
   ...
   * @param propertyType property type for mapping target (If this argument is not null, {@link
   *     org.apache.ibatis.type.TypeHandler} for property type is not registered)
   */
  ...
  private static String buildMessage(
      MappedStatement mappedStatement, String columnName, String property, Class<?> propertyType) {
