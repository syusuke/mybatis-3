...
public class ResultLoaderMap {
  ...
  public static class LoadPair implements Serializable {
    ...
    private LoadPair(
      ...
      if (metaResultObject != null
          && metaResultObject.getOriginalObject() instanceof Serializable) {
          ...
          if (log.isDebugEnabled()) {
            log.debug(
                "Property ["
                    + this.property
                    + "] of ["
                    + metaResultObject.getOriginalObject().getClass()
                    + "] cannot be loaded "
    ...
    private Configuration getConfiguration() {
      ...
      try {
        ...
        throw new ExecutorException(
            "Cannot get Configuration as factory class ["
                + this.configurationFactory
                + "] is missing factory method of name ["
                + FACTORY_METHOD
                + "].",
            ex);
