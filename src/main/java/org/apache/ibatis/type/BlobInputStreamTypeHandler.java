...
public class BlobInputStreamTypeHandler extends BaseTypeHandler<InputStream> {
  ...
  public void setNonNullParameter(
      PreparedStatement ps, int i, InputStream parameter, JdbcType jdbcType) throws SQLException {
  ...
  /**
   * Get an {@link InputStream} that corresponds to a specified column index from {@link
   * CallableStatement}.
   *
