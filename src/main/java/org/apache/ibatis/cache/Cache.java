 ...
 *
 * <p>One instance of cache will be created for each namespace.
 *
 * <p>The cache implementation must have a constructor that receives the cache id as an String
 * parameter.
 *
...
public interface Cache {
  ...
  /**
   * 缓存数量,并不是实现容量 Optional. This method is not called by the core.
   *
  ...
  /**
   * 获得读取写锁。该方法可以忽略了已经。 Optional. As of 3.2.6 this method is no longer called by the core.
   *
