 ...
 * #find(org.apache.ibatis.io.ResolverUtil.Test, String)} ()} method and supplying a package name
 * and a Test instance. This will cause the named package <b>and all sub-packages</b> to be scanned
 * for classes that meet the test. There are also utility methods for the common use cases of
 * scanning multiple packages for extensions of particular classes, or classes annotated with a
 * specific annotation.
 *
