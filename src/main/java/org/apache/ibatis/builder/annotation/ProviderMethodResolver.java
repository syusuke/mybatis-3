 ...
 *
 * <p>This interface need to implements at an SQL provider class and it need to define the default
...
public interface ProviderMethodResolver {
   ...
   *
   * <ul>
   *   <li>Method name matches with mapper method
   *   <li>Return type matches the {@link CharSequence}({@link String}, {@link StringBuilder},
   *       etc...)
   * </ul>
   *
