...
class ExecutorTestHelper {
                    ...
                    new ArrayList<ParameterMapping>() {
                      {
                        add(
                            new ParameterMapping.Builder(
                                    config, "id", registry.getTypeHandler(int.class))
                                .build());
                        add(
                            new ParameterMapping.Builder(
                                    config, "username", registry.getTypeHandler(String.class))
                                .build());
                        add(
                            new ParameterMapping.Builder(
                                    config, "password", registry.getTypeHandler(String.class))
                                .build());
                        add(
                            new ParameterMapping.Builder(
                                    config, "email", registry.getTypeHandler(String.class))
                                .build());
                        add(
                            new ParameterMapping.Builder(
                                    config, "bio", registry.getTypeHandler(String.class))
  ...
  static MappedStatement prepareInsertAuthorProc(final Configuration config) {
    ...
    return new MappedStatement.Builder(
            config,
            "insertAuthorProc",
            new StaticSqlSource(config, "{call insertAuthor(?,?,?,?)}"),
            SqlCommandType.INSERT)
        .parameterMap(
            new ParameterMap.Builder(
                    config,
                ...
                new ArrayList<ResultMapping>() {
                  {
                    add(
                        new ResultMapping.Builder(
                                config, "id", "id", registry.getTypeHandler(int.class))
                            .build());
                    add(
                        new ResultMapping.Builder(
                                config,
                    ...
                    add(
                        new ResultMapping.Builder(
                                config, "email", "email", registry.getTypeHandler(String.class))
                            .build());
                    add(
                        new ResultMapping.Builder(
                                config, "bio", "bio", registry.getTypeHandler(String.class))
                            .build());
                    add(
                        new ResultMapping.Builder(
                                config,
                            ...
                            new ArrayList<ResultMapping>() {
                              {
                                ...
                                add(
                                    new ResultMapping.Builder(
                                            config, null, "not_exists", Object.class)
                                        .build());
                              }
                            })
                        .build());
  ...
  static MappedStatement prepareSelectOneAuthorMappedStatementWithConstructorResults(
                    ...
                    new ArrayList<ParameterMapping>() {
                      {
                        add(
                            new ParameterMapping.Builder(
                                    config, "id1", registry.getTypeHandler(int.class))
                                .build());
                        add(
                            new ParameterMapping.Builder(
                                    config, "id2", registry.getTypeHandler(int.class))
                                .build());
                      }
                    })
                .build())
  ...
  static MappedStatement prepareSelectDiscriminatedPost(final Configuration config) {
                ...
                new ArrayList<ResultMapping>() {
                  {
                    add(
                        new ResultMapping.Builder(
                                config, "subject", "subject", registry.getTypeHandler(String.class))
                            .build());
                    add(
                        new ResultMapping.Builder(
                                config, "body", "body", registry.getTypeHandler(String.class))
                            .build());
                  }
                })
            .build();
    ...
    return new MappedStatement.Builder(
            config,
            "selectPosts",
            new StaticSqlSource(config, "SELECT * FROM post"),
            SqlCommandType.SELECT)
        .resultMaps(
            new ArrayList<ResultMap>() {
              {
                ...
                new ArrayList<ResultMapping>() {
                  {
                    ...
                    add(
                        new ResultMapping.Builder(
                                config, "title", "title", registry.getTypeHandler(String.class))
                            .build());
                    add(
                        new ResultMapping.Builder(
                                config,
                    ...
                    add(
                        new ResultMapping.Builder(
                                config, "author.bio", "bio", registry.getTypeHandler(String.class))
                            .build());
                    add(
                        new ResultMapping.Builder(
                                config, "posts", "id", registry.getTypeHandler(int.class))
                            .javaType(List.class)
  ...
  static MappedStatement prepareSelectBlogByIdAndAuthor(final Configuration config) {
                ...
                new ArrayList<ParameterMapping>() {
                  {
                    add(
                        new ParameterMapping.Builder(
                                config, "blogId", registry.getTypeHandler(int.class))
                            .build());
                    add(
                        new ParameterMapping.Builder(
                                config, "authorId", registry.getTypeHandler(int.class))
                            .build());
                  }
                })
            .build();
    ...
    return new MappedStatement.Builder(
            config, "selectBlogByIdAndAuthor", sqlSource, SqlCommandType.SELECT)
        .parameterMap(parameterMap)
        .resultMaps(
            new ArrayList<ResultMap>() {
              {
                ...
                new ArrayList<ResultMapping>() {
                  {
                    add(
                        new ResultMapping.Builder(
                                config, "id", "tag_id", registry.getTypeHandler(int.class))
                            .flags(
                                new ArrayList<ResultFlag>() {
                                  {
                                    add(ResultFlag.ID);
                    ...
                    add(
                        new ResultMapping.Builder(
                                config, "name", "tag_name", registry.getTypeHandler(String.class))
                            .build());
                  }
                })
            .build();
                ...
                new ArrayList<ResultMapping>() {
                  {
                    add(
                        new ResultMapping.Builder(
                                config, "id", "comment_id", registry.getTypeHandler(int.class))
                            .flags(
                                new ArrayList<ResultFlag>() {
                                  {
                                    add(ResultFlag.ID);
                    ...
                    add(
                        new ResultMapping.Builder(
                                config, "comment", "comment", registry.getTypeHandler(String.class))
                            .build());
                  }
                })
            .build();
                ...
                new ArrayList<ResultMapping>() {
                  {
                    ...
                    add(
                        new ResultMapping.Builder(
                                config, "blog", "blog_id", registry.getTypeHandler(int.class))
                            .javaType(Blog.class)
                    ...
                    add(
                        new ResultMapping.Builder(
                            ...
                            .build());
                    add(
                        new ResultMapping.Builder(config, "tags")
                            .nestedResultMapId(tagResultMap.getId())
                            .build());
                    add(
                        new ResultMapping.Builder(config, "comments")
                            .nestedResultMapId(commentResultMap.getId())
                            .build());
                  }
                })
            .build();
    return new MappedStatement.Builder(
            config, "selectPostsForBlog", sqlSource, SqlCommandType.SELECT)
        .parameterMap(parameterMap)
        .resultMaps(
            new ArrayList<ResultMap>() {
              {
  ...
  static MappedStatement prepareSelectPostWithBlogByAuthorMappedStatement(
      final Configuration config) {
    final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
    final SqlSource sqlSource =
        new StaticSqlSource(
                ...
                new ArrayList<ResultMapping>() {
                  {
                    ...
                    add(
                        new ResultMapping.Builder(config, "blog")
  ...
  static MappedStatement prepareInsertAuthorMappedStatementWithBeforeAutoKey(
      final Configuration config) {
    final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
    final ResultMap rm =
        new ResultMap.Builder(config, "keyResultMap", Integer.class, new ArrayList<>()).build();

    MappedStatement kms =
        new MappedStatement.Builder(
                config,
                "insertAuthor!selectKey",
                    ...
                    new ArrayList<ParameterMapping>() {
                      {
                        add(
                            new ParameterMapping.Builder(
                                    config, "id", registry.getTypeHandler(Integer.class))
                                .build());
                        add(
                            new ParameterMapping.Builder(
                                    config, "username", registry.getTypeHandler(String.class))
